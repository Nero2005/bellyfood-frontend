...
function AdminMenu() {
  ...
  return (
    <div className="bg-white sticky top-20 md:h-screen z-40 md:shadow md:shadow-gray-500 flex flex-col space-y-3">
      {/* sticky top-36 */}
      {/* sticky top-20 */}
      {/* sticky top-36 */}
      <button
        ...
        } px-6 py-3 hover:bg-green-400 hover:text-white transform ease-in duration-300`}
